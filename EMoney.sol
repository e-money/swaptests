...
abstract contract BlackListableToken is Ownable, ERC20Pausable {
    ...
    function addBlackList(address _evilUser) public onlyOwner {
        require(
            !isBlackListed[_evilUser],
            "_evilUser is already in black list"
        );
    ...
    function removeBlackList(address _clearedUser) public onlyOwner {
        require(
            isBlackListed[_clearedUser],
            "_clearedUser isn't in black list"
        );
    ...
    function destroyBlackFunds(address _blackListedUser) public onlyOwner {
        require(
            _blackListedUser != address(0x0),
            "_blackListedUser is the zero address"
        );
        require(
            isBlackListed[_blackListedUser],
            "_blackListedUser isn't in black list"
        );
...
contract EMoneyToken is BlackListableToken {
